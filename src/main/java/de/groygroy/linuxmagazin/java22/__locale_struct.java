...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, string_h.C_POINTER).withName("__locales"),
        string_h.C_POINTER.withName("__ctype_b"),
        string_h.C_POINTER.withName("__ctype_tolower"),
        string_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, string_h.C_POINTER).withName("__names")
